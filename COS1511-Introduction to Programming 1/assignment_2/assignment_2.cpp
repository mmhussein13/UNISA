    ...
    do {
        ...
        while (true) {
            ...
            if (cin.fail() || choice < 1 || choice > 5) {
                ...
                cout << "Incorrect option! Please choose from"
                    << " 1-5.\n" << endl;
            } else {
                cin.ignore(numeric_limits<streamsize>::max(), '\n');
                break;
...
void displayMenu(const vector<Flight>& flights) {
    ...
    cout << left << setw(10) << "Option" << setw(10) << "Depart" << setw(10)
        << "Arrive" << endl;
    printDashLine(30);
...
void displayBookingTicket(const string& fullName, const Flight& flight,
    ...
    string arrivalHourStr = (arrivalHour < 10 ? "0" : "") + to_string(arrivalHour);
    string arrivalMinuteStr = (arrivalMinute < 10 ? "0" : "") + to_string(arrivalMinute);
    displayTicketBanner();
    cout << left << setw(12) << "Name" << ": " << setw(20) << fullName << "Travel Ticket class \t: "
        << seatClass << endl;
    cout << left << setw(34) << "" << "Seat No." << "\t\t: " << seatLabel << endl;
    cout << left << setw(12) << "Departure" << ": " << setw(20) << "Johannesburg"
        << "Departure Time \t: " << flight.departureTime << endl;
    cout << left << setw(12) << "Destination" << ": " << setw(20) << "Cape Town"
        << "Arrival Time \t\t: " << arrivalHourStr << ":" << arrivalMinuteStr << endl;
