...
void displayBookingSummary(const vector<Flight>& flights, const vector<Booking>& bookings);
int main() {
...
void displayMenu(const vector<Flight>& flights) {
    ...
    cout << setw(6) << "Option" << setw(12) << "Depart" << setw(12) << "Arrive\n";
    ...
    for (size_t i = 0; i < flights.size(); ++i) {
        ...
        cout << setw(6) << to_string(i + 1) + "." << setw(12) << flights[i].departureTime << setw(12) << arrivalTime << endl;
    }
}
...
// Function to display the booking summary (with detailed bookings)
void displayBookingSummary(const vector<Flight>& flights, const vector<Booking>& bookings) {
    cout << "\nBooking Summary:\n";
    cout << "------------------------------------" << endl;
